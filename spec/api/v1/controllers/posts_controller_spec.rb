...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "unauthenticated user" do
    ...
    it "PUT update returns http unauthenticated" do
      put :update, topic_id: my_topic.id, id: my_post.id, post: {title: "Post Title", body: "Body"}
      expect(response).to have_http_status(401)
    end

    it "POST create returns http unauthenticated" do
      post :create, topic_id: my_topic.id, id: my_post.id, post: {title: "Post Title", body: "Body"}
      expect(response).to have_http_status(401)
    end

    it "DELETE delete returns http unauthenticated" do
  ...
  context "unauthorized user" do
    ...
    it "DELETE destroy returns htpp forbidden" do
      delete :destroy, topic_id: my_topic.id, id: my_post.id
      expect(response).to have_http_status(403)
    end
  ...
  context "authenticated and authorized users" do
    ...
    describe "PUT update" do
      ...
      it "updates the post" do
        updated_post = Post.where(topic_id: my_topic.id).last
    ...
    describe "POST create" do
      ...
      it "creates the post with correct attributes" do
